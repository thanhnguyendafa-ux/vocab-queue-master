...
function Navigation() {
    ...
    var _a = React.useState(location.pathname), activeTab = _a[0], setActiveTab = _a[1];
    var tabs = [
    ...
    return (<div className="bg-white border-t border-gray-200 fixed bottom-0 left-0 right-0 z-50 md:relative md:border-t-0 md:border-b">
      <div className="flex justify-around md:justify-start md:gap-8 px-4 py-2">
        {tabs.map(function (tab) {
            var Icon = tab.icon;
            var isActive = activeTab === tab.id;
            return (<button key={tab.id} onClick={function () { return handleTabChange(tab.id); }} className={"\n                flex flex-col items-center justify-center p-2 min-w-0 flex-1 md:flex-none md:px-4 md:py-3\n                transition-colors duration-200\n                ".concat(isActive
...
function AppContent() {
    return (<div className="min-h-screen bg-gray-50 pb-16 md:pb-0">
