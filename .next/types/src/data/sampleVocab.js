...
import { DEFAULT_MODULE_SETTINGS } from '../core/models';
export var sampleVocabItems = [
    {
        id: 'sample_1',
        term: 'abundant',
...
export function initializeSampleData() {
    return {
        items: __spreadArray(__spreadArray([], sampleVocabItems, true), extendedVocabItems, true),
...
//# sourceMappingURL=sampleVocab.js.map